...
class PolyAlphabetic_Cipher:
    ...
    def __init__(self, _secret_word: str) -> None:
        ...
        self.secret_numbers = [self.letters.index(letter.lower()) for letter in _secret_word.lower()]
    ...
    def _partition_word(self, _length: int, _word: str, _partitioned_words: list) -> list:
        if len(_word) == 0:
    ...
    def encrypt(self, _word: str):
        ...
        partitioned_words = self._partition_word(len_of_secret_numbers, _word.lower(), [])
    ...
    def decrypt(self, _encrypted_word: str):
        len_of_secret_numbers = len(self.secret_numbers)
        partitioned_words = self._partition_word(len_of_secret_numbers, _encrypted_word.lower(), [])
